	...
	*/
	...
	$schema = array(
		'confirmed' => array(
			...
			'country' => array('appgini' => 'VARCHAR(100) null '),
			'state' => array('appgini' => 'VARCHAR(100) null '),
			'lat' => array('appgini' => 'DECIMAL(10,4) null '),
			'long' => array('appgini' => 'DECIMAL(10,4) null '),
			'date' => array('appgini' => 'DATE null '),
			'value' => array('appgini' => 'INT null '),
			'calc_recovered' => array('appgini' => 'INT null '),
			'calc_deaths' => array('appgini' => 'INT null '),
		),
		'recovered' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'state' => array('appgini' => 'VARCHAR(100) null '),
