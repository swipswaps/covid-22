<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'recovered' table. 
	...
	*/
	...
	function recovered_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function recovered_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function recovered_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['state'], $data['country'], $data['lat'], $data['long'], $data['date_str'], $data['value']
	...
	*/
	...
	function recovered_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function recovered_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['state'], $data['country'], $data['lat'], $data['long'], $data['date_str'], $data['value']
	...
	*/
	...
	function recovered_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function recovered_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function recovered_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function recovered_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function recovered_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function recovered_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function recovered_batch_actions(&$args) {
