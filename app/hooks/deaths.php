<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'deaths' table. 
	...
	*/
	...
	function deaths_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function deaths_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function deaths_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function deaths_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function deaths_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function deaths_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function deaths_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function deaths_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function deaths_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function deaths_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function deaths_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function deaths_batch_actions(&$args) {
