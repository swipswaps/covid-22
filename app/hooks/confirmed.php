<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'confirmed' table. 
	...
	*/
	...
	function confirmed_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function confirmed_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function confirmed_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['state'], $data['country'], $data['lat'], $data['long'], $data['value']
	...
	*/
	...
	function confirmed_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['state'], $data['country'], $data['lat'], $data['long'], $data['date_str'], $data['value'], $data['calc_date'], $data['calc_recovered'], $data['calc_deaths']
	...
	*/
	...
	function confirmed_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['state'], $data['country'], $data['lat'], $data['long'], $data['value']
	...
	*/
	...
	function confirmed_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['state'], $data['country'], $data['lat'], $data['long'], $data['date_str'], $data['value'], $data['calc_date'], $data['calc_recovered'], $data['calc_deaths']
	...
	*/
	...
	function confirmed_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function confirmed_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function confirmed_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function confirmed_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function confirmed_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function confirmed_batch_actions(&$args) {
